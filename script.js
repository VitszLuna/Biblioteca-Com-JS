...
const books = [
  { 
    id: 1, 
    title: "Game On! Pac-Man", 
    author: "Jessica Rusick", 
    price: 178.43, 
    salePrice: 61.62, 
    cover: "https://m.media-amazon.com/images/I/71vkLMXe7kL._SY385_.jpg", 
    synopsis: "O jogo começou, fãs de PAC-MAN! Este título explora a criação e a evolução de PAC-MAN desde o seu lançamento nas máquinas arcade até o seu lugar duradouro na cultura pop, oferecendo uma visão aprofundada da história por trás do icônico personagem. Com entrevistas exclusivas, arte conceitual e segredos de desenvolvimento, este livro é uma leitura obrigatória para qualquer fã de videogames que queira entender como o PAC-MAN se tornou um fenômeno mundial. Descubra os desafios enfrentados pela equipe de desenvolvimento e o impacto que o jogo teve na indústria e na sociedade.", 
    pages: 64, 
    year: 2020 
  },
  { 
  ...
  { 
    id: 5, 
    title: "Beadcraft Arcade", 
    author: "Beadcraft Books", 
    price: 68.9, 
    salePrice: 59.0, 
    cover: "https://m.media-amazon.com/images/I/61vMgrYLT9L._SY522_.jpg", 
...
function openBookModal(book) {
  ...
  document.getElementById("modalBookYear").textContent = `Publicado em ${book.year}`
